...
-- -----------------------------------------------------
-- Table `pokemon`.`item_is_in_generation_games`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pokemon`.`item_is_in_generation_games` ;

CREATE TABLE IF NOT EXISTS `pokemon`.`item_is_in_generation_games` (
  `pk_item_is_in_generation_games` VARCHAR(45) NOT NULL,
  `pk_item` INT NOT NULL,
  `fk_version_group` INT NOT NULL,
  PRIMARY KEY (`pk_item_is_in_generation_games`),
  INDEX `fk_item_has_generation_item1_idx` (`pk_item` ASC) VISIBLE,
  INDEX `fk_item_is_in_generation_games_version_group1_idx` (`fk_version_group` ASC) VISIBLE,
  CONSTRAINT `fk_item_has_generation_item1`
    FOREIGN KEY (`pk_item`)
    REFERENCES `pokemon`.`item` (`pk_item`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_is_in_generation_games_version_group1`
...
-- -----------------------------------------------------
-- Table `pokemon`.`form_has_abilitiy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pokemon`.`form_has_abilitiy` ;

CREATE TABLE IF NOT EXISTS `pokemon`.`form_has_abilitiy` (
  `pk_form_has_abiity` VARCHAR(45) NOT NULL,
  ...
  INDEX `fk_form_has_abilities_version_group1_idx` (`fk_version_group` ASC) VISIBLE,
  PRIMARY KEY (`pk_form_has_abiity`),
  ...
  CONSTRAINT `fk_ability_form_generation_form1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_form_has_abilities_version_group1`
    FOREIGN KEY (`fk_version_group`)
    REFERENCES `pokemon`.`version_group` (`pk_version_group`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
